        ...
        <form id="login-form" method="post" class="login-form" style="min-width: 350px; max-width: 350px">
            ...
            <div class="row">
                <div class="input-field col s6 m6 l6">
                    <p class="margin medium-small"><a href="<c:url value="/pages/register.jsp" />">Register Now!</a></p>
                </div>
                <div class="input-field col s6 m6 l6">
                    <p class="margin right-align medium-small"><a href="<c:url value="/pages/forgot-password.jsp" />">Forgot
                        password?</a></p>
                </div>
            </div>
