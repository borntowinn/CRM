        ...
        <form id="addContactForm" class="form-horizontal" method="post" enctype="multipart/form-data">
           ...
           <div class="col-sm-5 col-md-5 main">
                <h2 class="page-header">Запланировать действие</h2>
                    ...
                    <div class="form-group">
                        <div class="col-xs-offset-3 col-xs-3">
                            <button type="submit" class="btn btn-primary" id="addTaskToContactButton">Добавить задачу и контакт</button>
                        </div>
                    </div>
           </div>
           ...
           <div class="col-sm-5 col-sm-offset-2 col-md-5 col-md-offset-2 main">
                ...
                <div class="form-group">
                    <label for="deal_phase" class="control-label col-xs-2">Этап</label>
                    <div class="col-xs-10">
                        <select class="form-control" id="deal_phase" name="deal_phase">
                ...
                <div class="form-group">
                    <label for="deal_budget" class="control-label col-xs-2">Бюджет</label>

                    <div class="col-xs-10">
                        <input type="text" class="form-control" id="deal_budget" name="deal_budget" placeholder="Бюджет">
                    </div>
                </div>

                <div class="form-group">
                    <div class="col-xs-offset-3 col-xs-3">
                        <button type="submit" class="btn btn-primary" id="addDealToContactButton">Добавить сделку и контакт</button>
                    </div>
                </div>
            </div>
           ...
           <div class="col-sm-5 col-md-5 main">
                ...
                <div class="form-group">
                    <div class="col-xs-offset-3 col-xs-3">
                        <button type="submit" class="btn btn-primary" id="setCompanyToContactButton" >Выбрать компанию и добавить контакт</button>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-xs-offset-3 col-xs-3">
                        <button type="submit" class="btn btn-primary" id="addCompanyToContactButton">Добавить контакт и компанию</button>
                    </div>
                </div>
            </div>
        </form>
